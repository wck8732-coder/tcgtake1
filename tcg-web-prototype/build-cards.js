...
,    31: 'When you cast this, deal 2 damage to target relic.\\nSwiftstrike\\nOverrun',
    ...
    63: 'Overrun',
    65: 'Swiftstrike',
    66: 'Flying\\nWhen this enters, Spore Trail 1.',
    67: 'Overrun\\nKeen Eye\\nVerdant Aura 1.',
    68: 'Keen Eye\\nWhen this enters, Pathfinder 1.',
    69: 'Swiftstrike',
    71: 'Overrun\\nWhen this enters, Alpha Call 1.',
    72: 'Overrun\\nKeen Eye\\nWhenever this attacks, Vine Lash 2.',
    73: 'Keen Eye\\nWhen this enters, Nature\'s Gift 1.',
    105: 'Siphon\\nRecall 1',
    106: 'Deathshroud',
    107: 'Deathshroud\\nRecall 1',
    108: 'Siphon',
    109: 'Deathshroud\\nGuard',
    111: 'Deathshroud\\nSiphon\\nAt the end of turn, Plague Breath 1.',
    112: 'Deathshroud\\nSiphon\\nBlight Aura 1.',
    113: 'Swiftstrike',
    114: 'Deathshroud\\nRecall 1',
    115: 'Deathshroud\\nSiphon\\nWhenever this attacks, Devour 5.',
    116: 'Swiftstrike\\nOminous',
    143: 'Intimidate\\nFlying',
    144: 'Flying\\nIntimidate\\nWhen this enters, Abyssal Roar 2.',
    147: 'Flying\\nIntimidate\\nWhenever this attacks, Maelstrom Pull 1.',
    150: 'Flying',
    151: 'Keen Eye\\nBastion\\nFlying',
    156: 'Flying',
    157: 'Flying\\nIntimidate\\nWhenever this attacks, Kraken Wake 3.',
    161: 'Swiftstrike',
    162: 'Swiftstrike',
    163: 'Keen Eye\\nGuard',
    164: 'Deathshroud',
    165: 'When you cast this, Disenchant.',
    166: 'Keen Eye\\nOverrun\\nWhen this enters, Fortify 2.',
    167: 'Quickdraw',
    168: 'Swiftstrike',
    169: 'Deathshroud',
    171: 'Keen Eye\\nBastion',
    ...
    174: 'Quickdraw',
    179: 'Flying',
    181: 'Overrun\\nKeen Eye\\nWhenever this attacks, Bull Rush 2.',
    200: 'Keen Eye\\nOverrun\\nConstrict 1.',
    351: 'When you cast this, Grave Tithe 1.',
    352: 'When you cast this, Tidal Pool 1.',
    359: 'When you cast this, Arcane Purge.',
    360: 'When you cast this, Reveal the Veil.',
    362: 'When you cast this, Echoing Ward 2.',
    366: 'Ominous\\nOverrun\\nWhenever this deals combat damage, Wild Rampage 2.',
    368: 'Ominous\\nWhenever this deals combat damage, Radiant Bastion 1.',
    372: 'Ominous\\nAt the end of turn, Assumed Identity 2.',
    374: 'Omen - At the end of turn, exchange the power and toughness of all champions until end of turn.',
    1014: 'Whenever you gain life, draw 1 card.',
    1016: 'When this enters, return a friendly champion with cost 2 or less from your graveyard.',
    1018: 'Whenever you play a champion, target champion with cost 1 or less gets +0/+1 until end of turn.',
    1020: 'Whenever you gain life, deal 1 damage to target enemy leader.',
    1023: 'Siphon\\nFriendly champions with Siphon get +1/+0 until end of turn.',
    1024: 'Whenever another friendly champion dies, you gain 1 life and target opponent loses 1 life.\\nWhenever another friendly champion dies, draw 1 card.',
    1035: 'When you cast this, reveal a card. Draw 1 card if the revealed card costs 2 or less.',
    1038: 'When you cast this, reveal a face-down Ominous unit. Deal 2 damage to target enemy unit if it is hidden.',
    1040: 'Omen - Whenever an enemy attacks, Purge the attacking unit.',
    1042: 'When you cast this, Purge target enemy unit. Draw 2 cards if the purged unit was a face-down Ominous unit.',
    1043: 'When this is revealed, you gain 1 life and target opponent loses 1 life.',
    1044: 'When you cast this, Purge target curse or omen. Deal 3 damage to any target.',
    1045: 'Whenever another friendly champion dies, create a 1/1 Token.',
    1048: 'When this is revealed, Purge a champion that dealt damage this turn.',
    1061: 'Whenever this attacks, other friendly champions get +1/+1 until end of turn.',
    1062: 'When you cast this, untap two target champions. Champions untapped this way get +1/+1 until end of turn.',
    1066: 'When you cast this, champions you control get +1/+1 until end of turn. Champions you control gain Guard until end of turn.',
    1067: 'Whenever this attacks, draw 1 card.',
    1069: 'When you cast this, attacking champions you control get +1/+1 until end of turn. Create a 1/1 Token if an attacking champion died this turn.',
    1072: 'Guard\\nWhenever this attacks, untap another friendly champion.',
    1076: 'When you cast this, draw a card, then discard a card. You gain 1 life if the discarded card costs 4 or more.',
    1086: 'When you cast this, return any target to its owner\'s hand. Draw 1 card.',
    1088: 'When you cast this, the next two cards you play cost 1 less each.',
    1090: 'When you cast this, target damaged champion gets -2/-0 until end of turn. Target damaged champion gets +0/-1 until end of turn.',
    1091: 'When this enters, a chosen card in your hand costs 1 less.',
    1092: 'When you cast this, return target champion to its owner\'s hand. Target opponent discards 1 card.',
    1103: 'Guard\\nWhen this enters, reveal the top 2 cards of your deck.',
    1104: 'Omen - At the end of turn, draw 1 card and you gain 1 life if you are neutral.',
    1107: 'When you cast this, Scry 1. Reveal a card in your hand.',
    1108: 'At the beginning of each non-draw step, this gets +1/+1 until end of turn.',
    1110: 'Omen - At the end of turn, choose one: Draw a card, or deal 1 damage to any target.',
    1115: 'When this dies, create a 1/1 Token.',
    1116: 'When you cast this, untap one target champion. It gets +1/+1 until end of turn.',
...
,    31: 'A vault is only a promise until the winch turns.',
    33: 'Gold buys loyalty, but a quick blade guarantees it stays bought.',
    40: 'Count the coins twice, cut the throats once, and always take your rightful share.',
    62: 'The deepest roots hold fast, unbothered by the storms that break the canopy.',
    63: 'No snare can hold the wild when the jungle decides to push back.',
    65: 'It steps without a sound, leaving only the memory of teeth and torn leaves.',
    66: 'Where the drake rests, the undergrowth blooms with a sudden, suffocating vibrancy.',
    67: 'Its footsteps carve new rivers; its roar scatters the oldest storm clouds.',
    68: 'Follow the briars, and you might learn how to walk the forest unseen.',
    69: 'Even in death, the creeping rot serves to feed the ever-hungry soil.',
    71: 'When the first howl echoes, the entire canopy shivers in fearful reverence.',
    72: 'Vines choke the unwary, but the serpent teaches them the meaning of true constriction.',
    73: 'Listen to the moss, and the ancient earth will grant you its enduring wisdom.',
    105: 'Graves are merely waiting rooms for those who understand the true currency of souls.',
    106: 'It skitters in the dark, weaving a shroud for the soon-to-be forgotten.',
    107: 'Honor rusted away long ago, leaving only a cold obedience to the crypt.',
    108: 'Flesh is fleeting, but the hunger it leaves behind endures for eternity.',
    109: 'A tapestry of bone and shadow, waiting patiently for the foolish to stumble.',
    111: 'Its breath wilts the strongest iron and turns courage into coughing ash.',
    112: 'He sits upon a throne of decay, ruling over subjects who never ask for rest.',
    113: 'When the sun dips, the shadows stretch forth to reclaim their stolen inheritance.',
    114: 'The swamp gives nothing back unless it is paid a tithe of marrow.',
    115: 'Roots drink water, but the elder knot feeds exclusively on the marrow of the fallen.',
    116: 'A pitiful existence, sustained only by a spiteful refusal to finally close its eyes.',
    143: 'The ocean does not negotiate; it simply takes until nothing is left.',
    144: 'From the crushing depths, a shadow rises to remind the surface of its insignificance.',
    147: 'Tides spiral inward, dragging ships and dreams down into the waiting jaws.',
    150: 'Sleek as a torpedo, it patrols the reef with a cold and calculating hunger.',
    151: 'A fortress carved from pearl, drifting lazily upon the currents of time.',
    156: 'Currents twist and break around it, yielding to a master of the tempest.',
    157: 'The spire shook, not from the storm above, but the awakening below.',
    161: 'A perfect gear asks for neither rest nor glory, only to turn the greater wheel.',
    162: 'Stamped from the forge, stepping in flawless rhythm with the grand ledger.',
    163: 'Time corrodes the shell, but the directive burns eternally within the brass heart.',
    164: 'Wound tight and left to scuttle across the margins of the great design.',
    165: 'With a precise strike of the hammer, the arcane knot unravels into harmless sparks.',
    166: 'Built to shoulder the sky and ignore the petty squabbles of the flesh.',
    167: 'Friction is a flaw to be eliminated through the steady application of oil and force.',
    168: 'Marching precisely in line, an endless parade of uniform purpose.',
    169: 'Sparks fly from its claws, sharpening a purpose that never truly dulls.',
    171: 'The road is protected by those who require no sleep and ask no questions.',
    172: 'A metallic howl cuts the night, signaling a hunt driven by springs and pistons.',
    174: 'Every problem is a nail if your swing carries the weight of the forge.',
    179: 'A fragile lattice of copper and glass, catching the thermal drafts of invention.',
    181: 'The ledger balances heavy on its back, yet it continues the endless trek forward.',
    200: 'Gears turn within gears, tightening the grip until the whole machine comes to a halt.',
    351: 'The toll for passage is never paid in silver; the ferryman prefers memories.',
    352: 'The waters recede, revealing exactly what the depths intended to leave behind.',
    359: 'The equation must balance, even if it means wiping the slate entirely clean.',
    360: 'The fog lifts for a fraction of a second, exposing a chilling, ancient truth.',
    362: 'Sound bounces through the deep caverns, multiplying the protective barrier with every echo.',
    366: 'The magma boils over, melting down reason and replacing it with pure, chaotic violence.',
    368: 'The sun grants its fiercest protection to those who weather the longest eclipses.',
    372: 'A mirror of brass and saltwater, showing you exactly what you dread to see.',
    374: 'The clock ticks backward, forcing every known variable to re-evaluate its place in the sequence.',
    1014: 'Blood is a currency best spent quickly, before the market realizes its true value.',
    1016: 'There is always enough meat left on the bone for those willing to dig.',
    1018: 'Under the pale moon, every drop spilled is a promise of power returned.',
    1020: 'Raise your glass high, for the poison works fastest on an inflated ego.',
    1023: 'He counts his wealth in heartbeats, taking from the weak to elevate his chosen.',
    1024: 'A beautiful smile masking an appetite that outlasts even the deepest treasuries.',
    1035: 'Read the scripture carefully, for the final verses demand a rather permanent sacrifice.',
    1038: 'Strip away the illusions, and you will find nothing but grinning bone underneath.',
    1040: 'The bell tolls not for the dead, but to warn the living of their arrival.',
    1042: 'Judgment is handed down from the crypt, swift and totally devoid of mercy.',
    1043: 'Gold stained by sorrow holds its value, though the coin feels oddly heavy.',
    1044: 'The holy texts dictate precisely how to sever a shadow from its lingering host.',
    1045: 'He calls them from the earth, eager hounds fashioned from lingering regrets and mud.',
    1048: 'Her museum accepts only the finest souls, preserved flawlessly in a state of eternal agony.',
    1061: 'Stand with the canopy, and you will borrow the strength of a thousand ancient roots.',
    1062: 'The momentum of the wild cannot be stopped by mere stone and steel.',
    1066: 'A roar echoed through the deep woods, turning fearful scouts into an unbreakable wall.',
    1067: 'Riding ahead of the overgrowth, mapping the routes where the vanguard will strike.',
    1069: 'The jungle reclaims everything, surging forward over the broken lines of its enemies.',
    1072: 'A commander of vines and beasts, leading the charge with unwavering primal authority.',
    1076: 'Discard the imperfect drafts; the final calculation demands absolute precision to function.',
    1086: 'The cycle shatters, dropping all expectations into a swirling vortex of uncertainty.',
    1088: 'Accelerate the mainspring and watch as the timeline folds beautifully in upon itself.',
    1090: 'Every action carries a cost; it is my job to collect the overdue payments.',
    1091: 'He sorts the probabilities, moving the most favorable outcomes to the front of the queue.',
    1092: 'The equation is flawed; we must erase it entirely and begin from zero.',
    1103: 'A silent watcher by the wayside, offering nothing but a clear view of the path.',
    1104: 'Hidden between the ledger lines, a fortune waits for those without allegiances.',
    1107: 'Consult the quiet road, for neutrality offers a clarity no empire can provide.',
    1108: 'A simple nod across the bustling floor secures a deal written in silent steel.',
    1110: 'Every intersection presents a test of will, demanding a choice before the dust settles.',
    1115: 'You buy the service, but the loyalty is strictly leased by the hour.',
    1116: 'Take the opening when it appears; hesitation is an inefficiency we cannot afford.',
